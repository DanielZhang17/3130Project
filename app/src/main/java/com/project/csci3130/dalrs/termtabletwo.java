...
public class termtabletwo extends AppCompatActivity {
    DatabaseHelper myDB;
    ...
    public termtabletwo(){ }
    public termtabletwo(DatabaseHelper2 dbh){
        myDB2=dbh;
    ...
    public void timeTable(){
        for (int k=0;
            ...
            if (numRows==0)
                Toast.makeText(termtabletwo.this,"Nothing in database", Toast.LENGTH_LONG).show();
            else{
                int i=0;
                ...
                columnsettertwo adapter=new columnsettertwo(this,R.layout.timetable2,userList);
