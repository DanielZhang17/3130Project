...
public class story1 {
    ...
    public void story1() {
                ...
                allOf(withId(R.id.email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView2.perform(scrollTo(), replaceText("sh9"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatAutoCompleteTextView3 = onView(
                allOf(withId(R.id.email), withText("sh9"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.detail), withText("Details"),
                        childAtPosition(
                                childAtPosition(
